...
class RegisterOtbScreen extends StatefulWidget {
  final String email;

  const RegisterOtbScreen({super.key, required this.email});

  @override
  _RegisterOtbScreenState createState() => _RegisterOtbScreenState();
}

class _RegisterOtbScreenState extends State<RegisterOtbScreen> {
